 ...
 */
#define CONFIG_WIFI_EXTRA_DEBUG
#define CONFIG_WIFI_EVENTS_DEBUG
#define CONFIG_WIFI_CMD_RESP_DEBUG
#define CONFIG_WIFI_SCAN_DEBUG
...
#define CONFIG_WIFI_SDIO_DEBUG
#define CONFIG_WIFI_FW_DEBUG
#define CONFIG_WIFI_UAP_DEBUG
