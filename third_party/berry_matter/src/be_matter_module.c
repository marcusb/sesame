...
#include "be_matter_clusters.h"
#include "be_matter_events.h"
#include "be_matter_opcodes.h"
#include "be_matter_vendors.h"
...
/* Sesame: TCP_async, HTTP_async, HTTP_remote removed — Tasmota bridge features */
...
/* Sesame: stripped to core + Window Covering (Shutter) only */
...
/* Sesame: UI and Profiler removed — Tasmota web UI and debug features */
...
module matter (scope: global, strings: weak) {
  ...
  // Profiler removed — sesame doesn't need Matter debug profiling
  ...
  // TCP_async, HTTP_async, HTTP_remote removed
  ...
  // Autoconf removed — sesame configures Window Covering directly
