/*
 * Sesame-specific gen_config.h
 *
 * Endpoint layout:
 *   Endpoint 0 (root node): Basic Information, General Commissioning,
 *     Network Commissioning, Access Control, Administrator Commissioning,
 *     Operational Credentials, Group Key Management, General Diagnostics,
 *     WiFi Network Diagnostics, OTA Software Update Requestor, Descriptor
 *   Endpoint 1 (window covering): Window Covering, Descriptor
 */
#pragma once

#define MATTER_BINDING_TABLE_SIZE 20
#define SCENES_MANAGEMENT_TABLE_SIZE 0
