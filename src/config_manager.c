...
#define NVS_PARTITION_DEVICE \
    DEVICE_DT_GET(DT_MTD_FROM_FIXED_PARTITION(DT_NODELABEL(psm_partition)))
#define NVS_PARTITION_OFFSET DT_REG_ADDR(DT_NODELABEL(psm_partition))
#define NVS_PARTITION_SIZE DT_REG_SIZE(DT_NODELABEL(psm_partition))
